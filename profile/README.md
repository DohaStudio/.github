...
```mermaid
flowchart TB
    DM[DohaMusic<br/>Personal AI Music Workspace]
    LM[DohaLM<br/>Lyrics Generation Provider]
    DA[DohaAudio<br/>Music Generation and Audio Processing Provider]
    DV[DohaVocal<br/>Singing Voice and Vocal Processing Provider]
...
| Repository | 역할 |
|---|---|
| [DohaMusic](https://github.com/DohaStudio/DohaMusic) | Personal AI Music Workspace, Project, Asset, Composition, Mix, Export |
| [DohaLM](https://github.com/DohaStudio/DohaLM) | Lyrics Generation, Analysis, Revision Provider |
| [DohaAudio](https://github.com/DohaStudio/DohaAudio) | Music Generation, Stem Separation, Audio Analysis Provider |
| [DohaVocal](https://github.com/DohaStudio/DohaVocal) | Singing Voice, Voice Conversion, Vocal Processing Provider |
